...
import com.ringfence.silentscheduler.schedule.data.SchedulingScheduleRepository
...
abstract class ScheduleModule {
    ...
    @Binds
    @Singleton
    abstract fun bindScheduleRepository(impl: SchedulingScheduleRepository): ScheduleRepository
